...
async def startup_db_init():
    ...
    try:
        ...
        if categories_count == 0:
            logger.info("📂 Creating default service categories...")
            default_categories = [
                {"id": str(uuid.uuid4()), "name_en": "Manicures", "name_de": "Maniküre", "name_fr": "Manucures"},
                {"id": str(uuid.uuid4()), "name_en": "Pedicures", "name_de": "Pediküre", "name_fr": "Pédicures"},
                {"id": str(uuid.uuid4()), "name_en": "Extensions", "name_de": "Verlängerungen", "name_fr": "Extensions"},
                {"id": str(uuid.uuid4()), "name_en": "Add-ons", "name_de": "Zusatzleistungen", "name_fr": "Suppléments"},
        ...
        if styles_count == 0:
            logger.info("🎨 Creating default gallery styles...")
            default_styles = [
                {"id": str(uuid.uuid4()), "name_en": "French", "name_de": "Französisch", "name_fr": "Français"},
                ...
                {"id": str(uuid.uuid4()), "name_en": "Artistic", "name_de": "Künstlerisch", "name_fr": "Artistique"},
        ...
        if colors_count == 0:
            ...
            default_colors = [
                ...
                {"id": str(uuid.uuid4()), "name_en": "Green", "name_de": "Grün", "name_fr": "Vert", "hex_code": "#2ECC71"},
                ...
                {"id": str(uuid.uuid4()), "name_en": "White", "name_de": "Weiß", "name_fr": "Blanc", "hex_code": "#FFFFFF"},
            ...
            logger.info(f"✅ Created {len(default_colors)} default colors")
